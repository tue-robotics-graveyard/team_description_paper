...
\author{J.~Scholtes, M.F.B.~van~der~Burgh, J.J.M.~Lunenburg, R.P.W.~Appeldoorn, R.W.J.~Wijnands, T.T.G.~Clephas, M.J.J.~Baeten, L.L.A.M.~van~Beek, R.A.~Ottervanger and M.J.G.~van~de~Molengraft}
\institute{Eindhoven University of Technology,
\newline Den Dolech 2, P.O. Box 513, 5600 MB Eindhoven, The Netherlands\\
\texttt{http://www.techunited.nl, techunited@tue.nl}}
\authorrunning{J.~Scholtes et al.}
...
\input{object_detection_recognition.tex}
...
\subsection{Innovative technology and scientific contribution}
\input{innovative_scientific.tex}

\subsection{Focus of research / research interests}
...
\input{applicability_real_world.tex}
