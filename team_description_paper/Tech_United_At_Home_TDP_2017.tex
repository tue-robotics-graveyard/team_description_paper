...
\authorrunning{M.F.B.~van~der~Burgh et al.}
...
Our main research efforts this year have focused on
i) improved object detection via deep learning methods, a generic GUI for different user levels and improved natural language interpretation. TODO
\end{abstract}
